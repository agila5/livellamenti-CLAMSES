...
# esami diversi, si provi a calcolarne la varianza eseguendo tutti gli step a mano. 
...
# provate a
# 1) Definire un vettore chiamato z "incollando" i vettori x ed y (definiti come
